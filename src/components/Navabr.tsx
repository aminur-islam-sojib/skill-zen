...
import { Home, User, GraduationCap, LayoutDashboardIcon, Mail } from "lucide-react";
...
export default function Navbar(): React.JSX.Element {
  ...
  return (
    <div className="sticky my-5">
      <motion.nav
        className="p-2 rounded-2xl w-11/12 mx-auto bg-white/60 dark:bg-black/60 backdrop-blur-lg border border-gray-200/80 dark:border-gray-800/80 shadow-lg dark:shadow-gray-900/20 relative overflow-hidden"
        initial="initial"
        whileHover="hover"
      >
        <motion.div
