...
const Footer = () => {
  return (
    <div className="w-full flex items-center justify-center h-full shadow mt-10">
      <div className="w-full h-full mx-auto [background:linear-gradient(45deg,#080b11,--theme(--color-slate-800)_50%,#172033)_padding-box,conic-gradient(from_var(--border-angle),--theme(--color-slate-600/.48)_80%,--theme(--color-teal-500)_86%,--theme(--color-cyan-300)_90%,--theme(--color-teal-500)_94%,--theme(--color-slate-600/.48))_border-box]   border border-transparent animate-border">
          ...
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <figure className=" h-15 w-auto">
                    <img src="/favicon.png" alt="Skill Zen Logo"  className=" h-full w-auto"/>
                </figure>
                <h3 className=" text-3xl sm:text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-linear-to-r from-cyan-500 to-cyan-600 dark:from-cyan-400 dark:to-cyan-500">
              Skill Zen
                </h3>
              </div>
